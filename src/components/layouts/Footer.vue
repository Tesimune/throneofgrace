        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://tesimune.vercel.app" class="flex items-center">
                    <img src="../../assets/logo.png" class="mr-3 h-8" alt="throne Logo" />
                    <span class="self-center md:text-2xl text-sm font-semibold whitespace-nowrap">Throne Of Grace Holy City</span>
                </a>
            </div>
